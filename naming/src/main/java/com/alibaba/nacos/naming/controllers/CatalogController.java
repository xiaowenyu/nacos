...
public class CatalogController {
     ...
     *
     * http://172.16.15.123:8848/nacos/v1/ns/catalog/services?hasIpCount=true&withInstances=false&pageNo=1&pageSize=10&serviceNameParam=&groupNameParam=&namespaceId=test
     *
    ...
    public Object listDetail(@RequestParam(required = false) boolean withInstances,
        ...
        return judgeCatalogService()
                // 异常情况是 catalogServiceV1， 正常是catalogServiceV2
